...
public class OBJ_Loader {
    ...
    public OBJ_Loader(String fileName){
        this.fileName = fileName;
        this.lines = AssetPool.readAllLines(this.fileName);
    }
    ...
    protected static class IdxGroup {
        ...
        public int idxPos; public int idxTextCoord;
